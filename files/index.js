...
const port = process.env.SERVER_PORT || process.env.PORT || 8700;        
const UUID = process.env.UUID || 'aa56d1a4-0598-45dc-89ee-07d98b1a7e91'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho9.hellostar.cf';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMGJiYWFkOTM2YzVlYzEwYjEwMTMyYzI5MGNhZmZlOTUiLCJ0IjoiMTcwZDBmNWMtOTg2NC00M2I4LWE4NGEtZTQ4ZjIwNTA1ZWQ3IiwicyI6IlpXWTVNVEJpWkRNdFpHUXhOeTAwTWpRMExUazRZV1V0WldNeVlqQmhaV1l4WW1WayJ9';
